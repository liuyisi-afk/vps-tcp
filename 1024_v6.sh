...
install_v2ray(){    
    bash <(curl -L https://v6.gh-proxy.org/https://raw.githubusercontent.com/v2fly/fhs-install-v2ray/master/install-release.sh)
...
install_ssrust(){
    wget https://v6.gh-proxy.org/https://raw.githubusercontent.com/yeahwu/v2ray-wss/main/ss-rust.sh && bash ss-rust.sh
}

install_reality(){
    wget https://v6.gh-proxy.org/https://raw.githubusercontent.com/yeahwu/v2ray-wss/main/reality.sh && bash reality.sh
}

install_hy2(){
    wget https://v6.gh-proxy.org/https://raw.githubusercontent.com/yeahwu/v2ray-wss/main/hy2.sh && bash hy2.sh
}

install_https(){
    wget https://v6.gh-proxy.org/https://raw.githubusercontent.com/yeahwu/v2ray-wss/main/https.sh && bash https.sh
}
